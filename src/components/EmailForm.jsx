  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full p-2 text-orange bg-white border border-white rounded-md hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
        >
          S'inscrire
        </button>
      </form>
